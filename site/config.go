...
func Init() {
	...
	c.Author = "김딜러"
	c.Title = "The Login Holdem"
	c.Description = "당신을 로그인 홀덤의 세계로 초대합니다. 여기는 강남홀덤과 압구정홀덤이 한 곳에서 만나는 뜨거운 경쟁의 무대입니다. 로그인 홀덤에서는 게임의 짜릿함을 느낄 수 있으며, 다양한 레벨의 플레이어와 함께 경험을 공유할 수 있습니다."
	k := Keywords([]string{"강남홀덤", "압구정홀덤", "로그인홀덤"})
	c.Keywords = &k
