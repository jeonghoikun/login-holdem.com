...
func Init() {
	...
	c.Author = "이사장"
	c.Title = "강남 홀덤 압구정 홀덤 킹덤"
	c.Description = "강남 홀덤 압구정 홀덤 킹덤은 홀덤 포커를 즐길 수 있는 공간으로, 카드 게임 팬들에게는 꼭 방문해야 하는 장소 중 하나입니다. 강남 홀덤 압구정 홀덤 두 곳은 서로 다른 분위기와 스타일을 가지고 있어 모든 유형의 홀덤 팬들에게 맞춤형 경험을 제공합니다."
